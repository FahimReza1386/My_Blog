...
class TestCommentModels(TestCase):
    ...
    def test_Create_like_Comment(self):
        ...
        comment=self.comment
        comment_like=Comment_Like.objects.create(comment=self.comment , user=self.user)
    ...
    def test_delete_like_Comment(self):
        ...
        comment_liked=Comment_Like.objects.filter(comment=self.comment , user=self.user)
