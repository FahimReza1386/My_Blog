...
class CommentApiSerializer(serializers.ModelSerializer):
    ...
    post=serializers.SlugRelatedField(many=False , slug_field="title" ,queryset=Post.objects.all())
    ...
    def to_representation(self, instance):
        ...
        if request.parser_context.get('kwargs').get('pk'):
            ...
            reps["post"] = BlogModelSerializer(instance.post , context={'request':request}).data
            reps["post"].pop("image")
