...
class CreatePostForm(forms.ModelForm):
    image = forms.CharField(label="تصویر خود را انتخاب نمایید ..." , help_text='', widget=forms.FileInput(attrs={'placeholder':"تصویر وبلاگ خود را بنویسید .."}))
    title = forms.CharField(label="" , help_text='', widget=forms.TextInput(attrs={'placeholder':"نام وبلاگ خود را بنویسید .."}))
    content = forms.CharField(label="" , help_text='', widget=forms.TextInput(attrs={'placeholder':"متن وبلاگ خود را بنویسید .."}))
