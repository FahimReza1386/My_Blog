...
class TestBlogApi:
    ...
    def test_api_get_post_detail_response_200(self, api_client, get_user, get_post):
        user = get_user
        api_client.force_login(user=user)
    ...
    def test_api_edit_post_response_200(
        self, api_client, get_user, get_post, get_category
    ):
        user = get_user
        api_client.force_login(user=user)
    ...
    def test_api_get_category_detail_response_200(
        self, api_client, get_user, get_category
    ):
        user = get_user
        api_client.force_login(user=user)
    ...
    def test_api_delete_category_response_204(self, get_user, get_category, api_client):
        ...
        assert response.status_code == 204
        assert get_category.__class__.objects.filter(id=category.id).exists() is False
